        ...
        x.extend({
            ...
            parseJSON: function (n) {
                return e.JSON && e.JSON.parse ? e.JSON.parse(n) : null === n ? n : "string" == typeof n && (n = x.trim(n),
                    n && E.test(n.replace(A, "@").replace(j, "]").replace(S, ""))) ? Function("return " + n)() : (x.error("Invalid JSON: " + n), t)
            },
            parseXML: function (n) {
                var r,
                    i;
                ...
                var n = 0,
                    ...
                    s = function (s, l, c, p, d) {
                        var h,
                            ...
                            x = s && [],
                            w = null != d,
                            C = u, N = s || a && o.find.TAG("*", d && l.parentNode || l),
